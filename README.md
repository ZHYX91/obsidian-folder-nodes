...
- Use natural name order without metadata or explicitly switch a parent to manual child order with sparse ranks on child notes. Structural moves never switch sorting mode implicitly.
