...
const zh = {
  ...
  unmanaged: "未管理", exempt: "已豁免", contentsUninitialized: "Folder Nodes 尚未初始化；当前只显示结构扫描结果，自动同步尚未启用。",
  ...
  renameFolderToMatch: "重命名文件夹以匹配", keepAsLeafNote: "保留为叶子笔记",
  ...
  leafPrefixRules: "Markdown 文件名前缀规则", leafPrefixRulesDesc: "匹配文件名开头；例如 _ 可豁免任意层级的 _index.md。",
  folderPrefixRules: "文件夹名称前缀规则", folderPrefixRulesDesc: "匹配任意路径段；命中的文件夹及完整子树不受管理。",
  leafPrefixItemDesc: "匹配此前缀的 Markdown 保持为叶子笔记", folderPrefixItemDesc: "匹配此前缀的文件夹子树不受管理",
  addPrefixRule: "添加前缀规则", addLeafPrefix: "添加 Markdown 文件名前缀", addFolderPrefix: "添加文件夹名称前缀",
  noPrefixRules: "暂无前缀规则。", noExemptions: "暂无路径。", add: "添加", remove: "移除",
...
const en: typeof zh = {
  ...
  unmanaged: "Unmanaged", exempt: "Exempt", contentsUninitialized: "Folder Nodes is not initialized. This is a structure preview; automatic synchronization is disabled.",
  ...
  renameFolderToMatch: "Rename folder to match", keepAsLeafNote: "Keep as leaf note",
  ...
  leafPrefixRules: "Markdown name-prefix rules", leafPrefixRulesDesc: "Match the start of a file name; for example, _ exempts _index.md at any level.",
  folderPrefixRules: "Folder name-prefix rules", folderPrefixRulesDesc: "Match any path segment; the matching folder and its complete subtree are unmanaged.",
  leafPrefixItemDesc: "Markdown with this prefix remains a leaf note", folderPrefixItemDesc: "Folder subtrees with this prefix are unmanaged",
  addPrefixRule: "Add prefix rule", addLeafPrefix: "Add Markdown name prefix", addFolderPrefix: "Add folder name prefix",
  noPrefixRules: "No prefix rules.", noExemptions: "No paths.", add: "Add", remove: "Remove",
