...
const zh = {
  ...
  nodes: "节点", album: "相册", files: "文件", video: "视频", openParent: "打开父节点", nodePath: "节点路径",
  needsRepair: "待修复", missingNodeNote: "缺少节点笔记", missingNodeFolder: "缺少同名文件夹", nodeConflict: "同名节点已存在",
...
const en: typeof zh = {
  ...
  nodes: "Nodes", album: "Album", files: "Files", video: "Video", openParent: "Open parent node", nodePath: "Node path",
  needsRepair: "Needs repair", missingNodeNote: "Missing Node Note", missingNodeFolder: "Missing same-named folder", nodeConflict: "Same-named node already exists",
